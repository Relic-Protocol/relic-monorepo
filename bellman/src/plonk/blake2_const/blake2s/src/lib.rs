...
pub use guts::{Implementation, Platform};
...
pub fn blake2s_const(input: &[u8]) -> Hash {
    EMPTY_PARAMS.hash_without_state(input)
}
...
impl Params {
    ...
    /// Equivalent to `Params::default()`.
    #[inline]
    pub const fn new_for_implementation(implementation: Implementation) -> Self {
        Self {
            hash_length: OUTBYTES as u8,
            key_length: 0,
            key_block: [0; BLOCKBYTES],
    ...
    /// Hash an input without keying and specialization.
    #[inline]
