...
#[derive(Clone)]
pub struct JiveTranscriptForRNS<'a, E: JiveEngine> {
    state: StatefulJive<'a, E>,
    rns_parameters: &'a RnsParameters<E, <<E as Engine>::G1Affine as GenericCurveAffine>::Base>
}

// impl<'a, E: JiveEngine> JiveTranscriptForRNS<'a, E> {
//     pub fn from_params(params: &'a E::Params) -> Self {
//         let stateful = StatefulJive::new(params);
...
impl<'a, E: JiveEngine> Prng<E::Fr> for JiveTranscriptForRNS<'a, E> {
    type Input = E::Fr;
    ...
    fn new_from_params(params: Self::InitializationParameters) -> Self {
        ...
        let stateful = StatefulJive::new(rescue_params);
...
impl<'a, E: JiveEngine> Transcript<E::Fr> for JiveTranscriptForRNS<'a, E> {
